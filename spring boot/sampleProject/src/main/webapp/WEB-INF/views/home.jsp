...
<html>
    <head>  
        ...
        <script src="/apps/jquery-ui.min.js"></script>
        <script src="/apps/bootstrap.min.js"></script>
        <script src="/apps/angular.js"></script>
        <script src="/apps/app.js"></script>
        <script src="/apps/service/userService.js"></script>
        <script src="/apps/controller/userController.js"></script>
        <style>
            .username.ng-valid {
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr ng-repeat="u in ctrl.users">
                                ...
                                <td>
                                    <button type="button" id="editbtn"  ng-click="ctrl.edit(u.id)" class="btn btn-success custom-width">Edit</button>  <button type="button" ng-click="ctrl.remove(u.id)" class="btn btn-danger custom-width">Remove</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
